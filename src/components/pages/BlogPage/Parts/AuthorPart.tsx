...
export const AuthorPart: React.FC<AuthorPartProps> = ({ postItem }) => {
  return (
    <>
      ...
      >
        <div
          className={`flex sm:flex-col justify-center sm:space-y-8 space-x-8 items-center py-2`}
        >
          <img
          ...
          />
          <h2 className="dark:text-white text-xl font-semibold">{postItem?.author?.name}</h2>
        </div>
      </div>
    </>
  );
