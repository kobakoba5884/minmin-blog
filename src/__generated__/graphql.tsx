...
export type PostManyWhereInput = {
  ...
  tags_some?: InputMaybe<PostTagsWhereInput>;
...
export type PostTagsConnectInput = {
...
export type PostTagsCreateManyInlineInput = {
  /** Connect multiple existing PostTags documents */
  connect?: InputMaybe<Array<PostTagsWhereUniqueInput>>;
  /** Create and connect multiple existing PostTags documents */
  create?: InputMaybe<Array<PostTagsCreateInput>>;
};

export type PostTagsCreateOneInlineInput = {
  /** Connect one existing PostTags document */
  connect?: InputMaybe<PostTagsWhereUniqueInput>;
  /** Create and connect one PostTags document */
  create?: InputMaybe<PostTagsCreateInput>;
};
...
export type PostTagsUpdateManyInlineInput = {
  /** Connect multiple existing PostTags documents */
  connect?: InputMaybe<Array<PostTagsConnectInput>>;
  /** Create and connect multiple PostTags documents */
  create?: InputMaybe<Array<PostTagsCreateInput>>;
  /** Delete multiple PostTags documents */
  delete?: InputMaybe<Array<PostTagsWhereUniqueInput>>;
  /** Disconnect multiple PostTags documents */
  disconnect?: InputMaybe<Array<PostTagsWhereUniqueInput>>;
  /** Override currently-connected documents with multiple existing PostTags documents */
  set?: InputMaybe<Array<PostTagsWhereUniqueInput>>;
  /** Update multiple PostTags documents */
  update?: InputMaybe<Array<PostTagsUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple PostTags documents */
  upsert?: InputMaybe<Array<PostTagsUpsertWithNestedWhereUniqueInput>>;
};

export type PostTagsUpdateManyWithNestedWhereInput = {
  Tag?: InputMaybe<TagUpdateManyWithNestedWhereInput>;
};

export type PostTagsUpdateOneInlineInput = {
  /** Connect existing PostTags document */
  connect?: InputMaybe<PostTagsWhereUniqueInput>;
  /** Create and connect one PostTags document */
  create?: InputMaybe<PostTagsCreateInput>;
  /** Delete currently connected PostTags document */
  delete?: InputMaybe<Scalars['Boolean']['input']>;
  /** Disconnect currently connected PostTags document */
  disconnect?: InputMaybe<Scalars['Boolean']['input']>;
  /** Update single PostTags document */
  update?: InputMaybe<PostTagsUpdateWithNestedWhereUniqueInput>;
  /** Upsert single PostTags document */
  upsert?: InputMaybe<PostTagsUpsertWithNestedWhereUniqueInput>;
};

export type PostTagsUpdateWithNestedWhereUniqueInput = {
  Tag?: InputMaybe<TagUpdateWithNestedWhereUniqueInput>;
};

export type PostTagsUpsertWithNestedWhereUniqueInput = {
